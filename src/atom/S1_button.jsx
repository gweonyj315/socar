...
const S1_button = ({children}) => {
    ...
    return <motion.button className="z-10 absolute bottom-10 right-20 bg-blue-600 gap-2 rounded-lg flex justify-center items-center p-5 px-7 text-white text-base font-medium"
    initial={hidden}
    animate={show}>
